package br.com.fiap.gere.residuo.morador.bairro.ms.advice;
...
public class ApplicationExceptionHandler {
    ...
    public Map<String, String> manusearDecodingException(DecodingException erro) {
        Map<String, String> errorMap = new HashMap<>();
        errorMap.put("message", "Erro ao tentar deserializar o JSON passado. Se estiver realizando CRUD de um bairro, verifique se está escrevendo corretamente o status de disponibilidade ([DISPONIVEL, OCUPADO])");
    ...
    public Map<String, String> manusearCaminhaoNaoEncontrado(BairroNaoEncontradoException erro) {
        Map<String, String> errorMap = new HashMap<>();
        errorMap.put("message", erro.getMessage());
    ...
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    @ExceptionHandler(BairroDmlException.class)
    public Map<String, String> manusearPrcColetaInvalido(BairroDmlException erro) {
        Map<String, String> errorMap = new HashMap<>();
        errorMap.put("message", erro.getMessage());
